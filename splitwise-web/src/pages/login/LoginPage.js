    ...
    return (
        <>
            <div className='container-fluid'>
                ...
                <div className='row mt-4' style={{ backgroundImage:`url('/images/facets.png')`}}>
                    <div className='col-md-12'>
                        <div className='login-section justify-content-center d-flex'>
                            <div className='login-box'>
                                <div>
                                    <label className='font-weight-500 font-size-28'>Log in</label>
                                </div>
                                <div>
                                    <label>Email address</label>
                                    <div className="input mb-4">
                                        <input autoCapitalize="off" type="email" name="email" onChange={handleChange} className='form-control' />
                                        {
                                ...
                                <div>
                                    ...
                                    <div className="input mb-4">
                                        <input autoCapitalize="off" type="password" name="password" onChange={handleChange} className='form-control' />
                                        {
                                ...
                                <div className='mt-5'>
                                    <button className='btn form-login-btn w-100' onClick={onSubmitLogin}>Log in</button>
                                </div>
                                <div className='mt-3 d-flex justify-content-center'>
                                    <div>
                                        <span className='lbl-forgot w-100 font-weight-600 pointer'>Forgot your password?</span>
                                    </div>
                                </div>
                                <div className='mt-4'>
                                    <button className="btn block cta-button font-weight-600  shadow px-4 py-2 text-center w-100" type="submit">
                                        <img className="inline-block mr-2 h-6 w-6" src="/images/google.png" alt='google' />
                                        Sign in with Google
                                    </button>
                                </div>
                            </div>
